...
services:
  prun-universe-map:
    ...
    container_name: prun-universe-map
...
```yaml
# Domain for the Prosperous Universe Map
PRUN_MAP_URL=prun-map.yourdomain.com

# Repository configuration (optional - defaults shown)
PRUN_MAP_REPO_URL=https://github.com/Taiyi-IITG/prun_universe_map.git
PRUN_MAP_REPO_BRANCH=main
```
